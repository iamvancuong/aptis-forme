...
@elseif($part == 4)
### Part 4 — Two Emails
**Task 1 – Informal Email to a Friend (~50 words)** — Casual, warm, personal.
**Task 2 – Formal Email to an Authority (120–150 words)** — Professional, polite, structured.
KEY: Did the student SWITCH REGISTER correctly between Task 1 (informal) and Task 2 (formal)?
