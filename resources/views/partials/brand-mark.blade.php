{{-- Logo chú chim nhại — dùng: @include('partials.brand-mark', ['size' => 32]) --}}
@php($size = $size ?? 32)
<svg width="{{ $size }}" height="{{ $size }}" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="{{ config('app.name') }}">
    <defs>
