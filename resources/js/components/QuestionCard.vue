...
<template>
    <section class="rounded-2xl bg-white p-5 ring-1 ring-slate-200">
        ...
        <!-- SPEAKING: Pha 4b (ghi âm) -->
        <div v-else-if="question.skill === 'speaking'" class="mt-3 rounded-lg bg-brand-50 px-3 py-2 text-xs text-brand-700">
            Phần Nói (ghi âm + chấm AI) đang được phát triển.
        </div>
